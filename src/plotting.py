...
def fig_3(N=100, res=40,output='./output/figures/figure3.png'):
    ...
    CSF= axs[0][0].contourf(X, Y, Z,zorder=1,levels=levels,cmap=sns.color_palette("ch:start=2.8,rot=.3",as_cmap=True))
    ...
    CSF= axs[1][1].contourf(N,X, Z,zorder=1,levels=levels,cmap=sns.color_palette("ch:start=1.3,rot=-.1",as_cmap=True))
    axs[1][1].set_ylabel(r'$\sigma$' + ' (varying effects)')
    axs[1][1].set_xlabel('Sample size')
